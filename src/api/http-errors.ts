// WARNING - copied / adapted from https://github.com/thiagobustamante/typescript-rest/blob/master/src/server/model/errors.ts
...
export abstract class HttpError extends Error {
  ...
  public constructor(name: string, public message: string) {
    super(message);
    this.name = name;
  }
}
